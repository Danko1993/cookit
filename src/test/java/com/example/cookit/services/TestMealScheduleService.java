...
//        mealScheduleDto = new MealScheduleDto(UUID.randomUUID(),new Date(),mealsId);
//        meals = new ArrayList<>();
//        meals.add(meal);
//        meals.add(meal2);
...
//        when(mealService.validateMealsIds(mealsId)).thenReturn(true);
...
//        verify(mealService,times(1)).validateMealsIds(mealsId);
//        verify(mealService,times(1)).getMealsById(mealsId);
...
//    }
//    @Test
//    void addMealScheduleAndBindWithDietPlanFailureMealsNotFound() {
//        when(dietPlanService.existById(mealScheduleDto.dietPlanId())).thenReturn(true);
//        when(mealService.validateMealsIds(mealsId)).thenReturn(false);
//
//        ResponseEntity<String> response = mealScheduleService.addMealScheduleAndBindWithDietPlan(mealScheduleDto);
//
//        verify(dietPlanService,times(1)).existById(mealScheduleDto.dietPlanId());
...
//        assertEquals(response.getBody(),"At least one meal not found in database.");
//    }
//    @Test
...
//
//        verify(dietPlanService,times(1)).existById(mealScheduleDto.dietPlanId());
//        verify(mealService,times(0)).validateMealsIds(mealsId);
//        verify(mealService,times(0)).getMealsById(mealsId);
//        verify(mealScheduleRepository,times(0)).save(mealSchedule);
//        assertEquals(response.getStatusCode(), HttpStatus.NOT_FOUND);
...
//        when(mealService.validateMealsIds(updateMealScheduleDto.mealIds())).thenReturn(true);
...
//    }
//    @Test
//    void updateMealScheduleFailureMealsNotFound() {
//        when(mealScheduleRepository.existsById(updateMealScheduleDto.mealScheduleId())).thenReturn(true);
//        when(mealScheduleRepository.findById(updateMealScheduleDto.mealScheduleId())).thenReturn(Optional.of(mealSchedule));
//        when(mealService.validateMealsIds(updateMealScheduleDto.mealIds())).thenReturn(false);
//
//        ResponseEntity<String> response = mealScheduleService.updateMealSchedule(updateMealScheduleDto);
//        verify(mealScheduleRepository,times(1)).existsById(updateMealScheduleDto.mealScheduleId());
//        verify(mealScheduleRepository,times(1)).findById(updateMealScheduleDto.mealScheduleId());
//        verify(mealService,times(1)).validateMealsIds(updateMealScheduleDto.mealIds());
//        verify(mealService,times(0)).getMealsById(mealsId);
//        verify(mealScheduleRepository,times(0)).save(mealSchedule);
//        assertEquals(response.getStatusCode(), HttpStatus.NOT_FOUND);
//        assertEquals(response.getBody(),"At least one meal not found in database.");
...
//        verify(mealService,times(0)).validateMealsIds(updateMealScheduleDto.mealIds());
//        verify(mealService,times(0)).getMealsById(mealsId);
//        verify(mealScheduleRepository,times(0)).save(mealSchedule);
//        assertEquals(response.getStatusCode(), HttpStatus.NOT_FOUND);
